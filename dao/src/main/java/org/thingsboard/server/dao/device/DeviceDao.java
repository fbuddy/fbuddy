...
public interface DeviceDao extends Dao<Device>, TenantEntityDao, ExportableEntityDao<DeviceId, Device> {
    ...
    PageData<Device> findDevicesByTenantIdAndTypeAndEmptyOtaPackage(UUID tenantId, UUID deviceProfileId, OtaPackageType type, PageLink pageLink);
    ...
    Optional<Device> findDeviceByMeterNo(Long meterNo);
    ...
    Map<String, Map<String, Long>> findMeterSummary(MeterFilter meterFilter);

    PageData<Device> findMeter(MeterFilter meterFilter, PageLink pageLink);
}
