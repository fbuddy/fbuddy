...
public class DeviceServiceImpl extends AbstractCachedEntityService<DeviceCacheKey, Device, DeviceCacheEvictEvent> implements DeviceService {
    ...
    @Override
    public Device findDeviceByMeterNo(Long meterNo) {
        log.trace("Executing findDeviceByMeterNo [{}][{}]", meterNo);
        return deviceDao.findDeviceByMeterNo(meterNo).orElse(null);
    }
