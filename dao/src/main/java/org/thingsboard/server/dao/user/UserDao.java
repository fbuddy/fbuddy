...
public interface UserDao extends Dao<User>, TenantEntityDao {
    ...
    PageData<User> findAllWithFilter(UserFilterForm userFilter, PageLink pageLink);

    PageData<User> findAllByRolesWithFilter(UserFilterForm userFilter, PageLink pageLink);
    ...
    User findBySerialNumber(TenantId tenantId, Integer serialNumber);
