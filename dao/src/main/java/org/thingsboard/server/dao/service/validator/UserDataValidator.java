...
public class UserDataValidator extends DataValidator<User> {
    ...
    protected void validateDataImpl(TenantId requestTenantId, User user) {
        ...
        /*if(user.getId() == null && !user.getRoleIds().isEmpty()) {
        ...
        User existentUserWithUserName = userService.findUserByUserName(tenantId, user.getUserName());
        if (existentUserWithUserName != null && !isSameData(existentUserWithUserName, user)) {
            throw new DataValidationException("User with username '" + user.getUserName() + "' "
                    + " already present in database!");
        }
    ...
    private void validatePassword(String password, String confirmPassword) {
        ...
        {
            throw new DataValidationException("Password and confirm Password not matched!");
        }
