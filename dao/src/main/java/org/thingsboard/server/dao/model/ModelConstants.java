...
public class ModelConstants {
    ...
    public static final String STATUS_PROPERTY = "name";
    ...
    public static final String USER_ROLE_HIBERNATE_TABLE_NAME = "tb_user_role";
     ...
     * HouseHold constants.
     */
    public static final String HOUSE_HOLD_TABLE_NAME = "households";
    public static final String HOUSE_HOLD_HOUSE_HOLD_ID_PROPERTY = "household_id";
    public static final String HOUSE_HOLD_W_ID_PROPERTY = "w_id";
    public static final String HOUSE_HOLD_TV_ID_PROPERTY = "tv_id";
    public static final String HOUSE_HOLD_MEMBER_INFO_PROPERTY = "member_info";
    public static final String HOUSE_HOLD_FIELD_STATUS_PROPERTY = "field_status";
    public static final String HOUSE_HOLD_PROFILE_ID_PROPERTY = "profile_id";

    public static final String HOUSE_HOLD_LOG_TABLE_NAME = "household_log";
    public static final String HOUSE_HOLD_LOG_HOUSE_HOLD_ENTITY_ID_PROPERTY = "household_entity_id";
    public static final String HOUSE_HOLD_LOG_PREVIOUS_ID = "previous_id";

    public static final String REMOTE_TABLE_NAME = "remotes";
    public static final String REMOTE_NO = "remote_no";
    public static final String REMOTE_SERIAL_NO = "remote_serial_no";
    public static final String REMOTE_SW_VERSION = "sw_version";
    public static final String REMOTE_HW_VERSION = "hw_version";
    ...
    public static final String REMOTE_CREATED_BY = "created_by";
     ...
     */
    public static final String FIELD_ALARM_RAISED = "field_alarm_raised";
     ...
     */
    public static final String ASSET_INSTALLATION_TABLE_NAME = "asset_installation_details";
    public static final String HOUSE_HOLD_ID = "household_id";
    public static final String METER_NO = "meter_no";
    public static final String TV_ID = "tv_id";
    public static final String PMA_W_ID = "pma_w_id";
    public static final String FIELD_MODE = "field_mode";
    public static final String METER_INSTALLATION_STATUS = "meter_installation_status";
    public static final String REMOTE_INSTALLATION_STATUS = "remote_installation_status";
    public static final String REMOTE_REMARKS = "remote_remarks";
    public static final String METER_REMARKS = "meter_remarks";
     ...
     * User Role constants.
     */
    public static final String USER_ROLE_MODULE_TABLE_NAME = "tb_module";
    public static final String USER_ROLE_ID_PROPERTY = "role_id";
    public static final String USER_MODULE_ID_PROPERTY = "module_id";

    public static final String USER_ROLE_TABLE_NAME = "tb_role";
    ...
    public static final String USER_ROLE_PERMISSION_TABLE_NAME = "tb_role_permission";
    public static final String USER_ROLE_VIEW_PERMISSION_PROPERTY = "view_permission";
    public static final String USER_ROLE_EDIT_PERMISSION_PROPERTY = "edit_permission";
