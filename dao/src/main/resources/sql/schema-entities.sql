...
CREATE TABLE IF NOT EXISTS tb_user (
    ...
    profile_status character varying(50),
    household_type character varying(50),
    max_record_per_page INTEGER
);
...
(
    ...
    w_id bigint,
    member_info jsonb,
    field_status character varying,
    profile_id uuid,
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS asset_installation_details
(
    id uuid NOT NULL PRIMARY KEY,
    household_id bigint NOT NULL,
    meter_no bigint NOT NULL,
    remote_no bigint NOT NULL,
    tv_id integer NOT NULL,
    pma_w_id character varying(50),
    meter_type character varying(40) NOT NULL,
    field_mode character varying(50),
    meter_installation_status character varying(50) NOT NULL,
    m_installation_active_from bigint NOT NULL,
    m_installation_active_to bigint,
    remote_installation_status character varying(50) NOT NULL,
    r_pairing_active_from bigint NOT NULL,
    r_pairing_active_to bigint,
    meter_remarks text,
    remote_remarks text,
    is_active boolean,
    ...
    updated_time bigint NOT NULL,
    created_time bigint NOT NULL,
	UNIQUE (household_id, meter_no, remote_no, tv_id, meter_installation_status, remote_installation_status)
 );