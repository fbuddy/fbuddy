...
public class AuthController extends BaseController {
    ...
    public ResponseEntity<String> checkActivateToken(
        ...
        if (userCredentials != null) {
            String baseUrl = systemSecurityService.getBaseUrl(TenantId.SYS_TENANT_ID, null, null);

            String createURI = baseUrl+"/login/createPassword";
            try {
    ...
    public void requestResetPasswordByEmail(
        ...
        try {
            ...
            /*String resetUrl = String.format("%s/login/resetPassword?resetToken=%s", baseUrl,
                    userCredentials.getResetToken());*/
    ...
    public ResponseEntity<String> checkResetToken(
        ...
        HttpStatus responseStatus;
        String baseUrl = systemSecurityService.getBaseUrl(TenantId.SYS_TENANT_ID, null, null);
        String resetURI = baseUrl + "/login/resetPassword";
    ...
    public JwtPair activateUser(
        ...
        String baseUrl = systemSecurityService.getBaseUrl(user.getTenantId(), user.getCustomerId(), null);
