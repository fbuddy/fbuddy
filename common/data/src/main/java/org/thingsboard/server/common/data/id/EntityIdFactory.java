    ...
    public static EntityId getByTypeAndUuid(EntityType type, UUID uuid) {
        switch (type) {
            ...
            case ROLE_PERMISSION:
                return new RolePermissionId(uuid);
            case USER_ROLE:
                return new UserRoleId(uuid);
            case HOUSE_HOLD:
                return new HouseHoldEntityId(uuid);
            case ASSET_INSTALLATION:
                return new AssetInstallationId(uuid);
            case REMOTE:
                return new RemoteEntityId(uuid);
        }
