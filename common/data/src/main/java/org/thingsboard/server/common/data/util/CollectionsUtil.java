...
public class CollectionsUtil {
    ...
    public static Map<String, Long> getCtPctData(Long count, Long percentage) {
        Map<String, Long> ctPctData = new HashMap<>();
        ctPctData.put("count", count);
        ctPctData.put("percentage", percentage);
        return ctPctData;
    }
}
