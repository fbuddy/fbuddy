...
public interface UserService extends EntityDaoService {
    ...
    PageData<User> findAllUsersWithFilters(UserFilterForm userFilter, PageLink pageLink);
    ...
    User setUserRolesAndAuthorities(User user);

    User findUserBySerialNumber(TenantId tenantId, Integer serialNumber);

    User findByEmailOrUserNameOrPhone(TenantId sysTenantId, String username);
